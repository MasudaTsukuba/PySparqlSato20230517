...
def execute_query(query_URI):
    # query_URI = 'query.json'  ######### 20230501
    output = query_URI.replace('.json', '.csv').replace('query/', 'output/')  # 'output.csv'  ######### 20230501
    ...
    for element in query_dict['where']:
        if element['type'] == 'filter':
            ...
            filter_list.append([prefix[0]['value'], prefix[0]['value'] + ' ' + element['expression']['operator'] + ' "'
                                + prefix[1]['value'] + '"'])
...
if __name__ == '__main__':
    ...
    query = 'query/q5.json'
    query = 'query/q6.json'
    query = 'query/q1pred_hotel.json'
    query = 'query/q1pred_build.json'
    query = 'query/q1pred_museum.json'
    query = 'query/q1pred_heritage.json'
